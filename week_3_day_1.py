...
# #now include the variables you just made print the following ...
...
# [name] liked to hum the song [song] while coding. It was so annoying
# that their teammates would throw [food] until [name] would stop singing.
